<?php defined('IN_DESTOON') or exit('Access Denied');?><script type="text/javascript">var user_auth = get_cookie('auth');</script>
<div class="user" style="height:180px;">
<?php if(defined('TOHTML')) { ?>
<script type="text/javascript">document.write(user_auth ? '<div>' : '<div style="display:none;">');</script>
<?php } else { ?>
<?php if($_userid) { ?><div><?php } else { ?><div style="display:none;"><?php } ?>
<?php } ?>
...
<td><img src="<?php echo $MODULE['2']['linkurl'];?>image/ico_product.gif" align="absmiddle"/> <a href="<?php echo $EXT['spread_url'];?>">推广企业产品</a></td>
</tr>
<tr>
...
<?php } else { ?>
<?php if($_userid) { ?><div style="display:none;"><?php } else { ?><div><?php } ?>
<?php } ?>
