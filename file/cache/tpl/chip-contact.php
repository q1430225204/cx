...
<?php if($member['mobile']) { ?><li><span>手机</span><?php echo anti_spam($member['mobile']);?><?php if($DT['sms'] && $member['vmobile']) { ?>&nbsp;&nbsp;<a href="<?php echo $MODULE['2']['linkurl'];?>sms.php?action=add&auth=<?php echo encrypt($member['mobile']);?>" target="_blank"><img src="<?php echo DT_SKIN;?>image/sendsms.gif" align="absmiddle" title="发送短信" alt=""/></a><?php } ?></li><?php } ?>
...
<li class="t_c" style="border:none;padding:8px 0 0 0;"><a href="<?php echo $member['linkurl'];?>" target="_blank" class="t"><img src="<?php echo DT_SKIN;?>image/btn_homepage.gif" title="进入企业网站"/></a> </li>
<?php } else { ?>
...
&nbsp;
<a href="<?php echo $MODULE['2']['linkurl'];?><?php if($currency=='money') { ?>charge.php?action=pay<?php } else { ?>credit.php?action=buy<?php } ?>"><img src="<?php echo DT_SKIN;?>image/btn_charge.gif" width="100" height="30" alt="帐户充值"/></a>
</td>
</tr>
</table>
</div>
...
<div class="user_reg_c"><a href="<?php echo $MODULE['2']['linkurl'];?><?php echo $DT['file_register'];?>"><img src="<?php echo DT_SKIN;?>image/user_reg.gif" width="260" height="26" alt="还不是会员，立即免费注册"/></a></div>
<?php } else { ?>
<br/><br/><br/>
