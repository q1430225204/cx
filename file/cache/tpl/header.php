...
| <a href="<?php echo $MODULE['3']['linkurl'];?>shortcut.php" rel="nofollow">加入桌面</a>
<?php if($DT['city']) { ?> | [<span id="destoon_city"><?php echo $city_name;?></span>] <a href="<?php echo DT_PATH;?>city.php" title="点击切换城市">切换</a><?php } ?>
</div>
</div>
</div>
<div class="m"><div id="search_tips" style="display:none;"></div></div>
<div class="m">
<div class="f_l logo"><a href="<?php echo $MODULE['1']['linkurl'];?>"><img src="<?php if($MODULE[$moduleid]['logo']) { ?><?php echo DT_SKIN;?>image/logo_<?php echo $moduleid;?>.gif<?php } else if($DT['logo']) { ?><?php echo $DT['logo'];?><?php } else { ?><?php echo DT_SKIN;?>image/logo.gif<?php } ?>" alt="<?php echo $DT['sitename'];?>"/></a></div>
...
<a href="<?php echo $EXT['spread_url'];?>"><img src="<?php echo DT_SKIN;?>image/btn_word.gif" width="32" height="32" alt="排名推广"/><br/>
<span>排名推广</span></a>
</div>
<div class="f_l btntool">
...
<div class="f_l btntool">
<a href="<?php echo $MODULE['2']['linkurl'];?>"><img src="<?php echo DT_SKIN;?>image/btn_user.gif" width="32" height="32" alt="会员中心"/><br/>
<span>会员中心</span></a>
</div>
</div>
<div class="m">
...
<div class="menu_b">
<div class="menu">
<ul><li<?php if($moduleid<4) { ?> class="menuon"<?php } ?>><a href="<?php echo $MODULE['1']['linkurl'];?>"><span>首页</span></a></li><?php if(is_array($MODULE)) { foreach($MODULE as $m) { ?><?php if($m['ismenu']) { ?><li<?php if($m['moduleid']==$moduleid) { ?> class="menuon"<?php } ?>><a href="<?php echo $m['linkurl'];?>"<?php if($m['isblank']) { ?> target="_blank"<?php } ?>><span<?php if($m['style']) { ?> style="color:<?php echo $m['style'];?>;"<?php } ?>><?php echo $m['name'];?></span></a></li><?php } ?><?php } } ?></ul>
</div>
</div>
