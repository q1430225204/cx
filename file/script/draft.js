...
document.write('<img src="'+DTPath+'file/image/fck_zo.gif" title="'+L['zoom_out']+'" onclick="fck_zo();"/> ');

document.write('<img src="'+DTPath+'file/image/fck_zi.gif" title="'+L['zoom_in']+'" onclick="fck_zi();"/> ');
...
function fck_zi() {var h = Number(Dd('content___Frame').height.replace('px', '')); h = h + 150; Dd('content___Frame').height = h+'px';}

function fck_zo() {var h = Number(Dd('content___Frame').height.replace('px', '')); h = h - 150; if(h > 200) Dd('content___Frame').height = h+'px';}
