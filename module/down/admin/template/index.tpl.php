...
<td><img src="<?php echo DT_PATH;?>file/ext/<?php echo $v['fileext'];?>.gif"/></td>
...
<?php } ?>
<td class="px11"><?php echo $v['download'];?></td>
...
<input type="submit" value=" 更新所有 " class="btn" onclick="this.form.action='?moduleid=<?php echo $moduleid;?>&file=html&action=show&update=1';" title="更新该模块所有下载地址等项目"/>&nbsp;
