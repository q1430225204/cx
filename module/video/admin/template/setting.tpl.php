...
<tr>
<td class="tl">默认视频[宽X高]</td>
<td>
<input type="text" size="3" name="setting[video_width]" value="<?php echo $video_width;?>"/>
X
<input type="text" size="3" name="setting[video_height]" value="<?php echo $video_height;?>"/> px
</td>
</tr>
...
<tr>
<td class="tl">视频播放器</td>
<td><input type="text" name="setting[player]" size="60" value="<?php echo $player;?>"/></td>
</tr>
<tr>
<td class="tl">内容页自动播放视频</td>
<td>
<input type="radio" name="setting[autostart]" value="1"  <?php if($autostart) echo 'checked';?>/> 开启&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" name="setting[autostart]" value="0"  <?php if(!$autostart) echo 'checked';?>/> 关闭
</td>
</tr>
<tr>
<td class="tl">FLV播放器LOGO</td>
<td><input type="text" name="setting[flvlogo]" size="30" value="<?php echo $flvlogo;?>"/><?php tips('请填写问名称，建议制作透明PNG格式，覆盖file/image/video.png');?><br/>
<img src="file/image/<?php echo $flvlogo;?>"/></td>
</tr>
<tr>
<td class="tl">FLV播放器LOGO位置</td>
<td><input type="text" name="setting[flvmargin]" size="30" value="<?php echo $flvmargin;?>" id="flvmargin"/>
<select onchange="if(this.value) Dd('flvmargin').value=this.value;">
<option>请选择</option>
<option value="10 auto auto 10"<?php echo $flvmargin == '10 auto auto 10' ? ' selected' : '';?>>左上角</option>
<option value="10 10 auto auto"<?php echo $flvmargin == '10 10 auto auto' ? ' selected' : '';?>>右上角</option>
<option value="auto auto 10 10"<?php echo $flvmargin == 'auto auto 10 10' ? ' selected' : '';?>>左下角</option>
<option value="auto 10 10 auto"<?php echo $flvmargin == 'auto 10 10 auto' ? ' selected' : '';?>>右下角</option>
</select>
</td>
</tr>
<tr>
<td class="tl">FLV播放器LOGO链接</td>
<td><input type="text" name="setting[flvlink]" size="60" value="<?php echo $flvlink;?>"/><?php tips('请填写http://开头的绝对地址，留空默认链接至网站首页');?></td>
</tr>
<tr>
<td class="tl">FLV播放器片头广告</td>
<td><input type="text" name="setting[flvstart]" size="60" value="<?php echo $flvstart;?>" id="flvstart"/>&nbsp;&nbsp;<span onclick="Dfile(<?php echo $moduleid;?>, Dd('flvstart').value, 'flvstart', 'flv|mp4');" class="jt">[上传]</span>&nbsp;&nbsp;<span onclick="Dd('flvstart').value='';" class="jt">[删除]</span> <?php tips('请填写http://开头的绝对地址，目前支持FLV、MP4格式');?></td>
</tr>
<tr>
<td class="tl">FLV播放器片尾广告</td>
<td><input type="text" name="setting[flvend]" size="60" value="<?php echo $flvend;?>" id="flvend"/>&nbsp;&nbsp;<span onclick="Dfile(<?php echo $moduleid;?>, Dd('flvend').value, 'flvend', 'flv|mp4');" class="jt">[上传]</span>&nbsp;&nbsp;<span onclick="Dd('flvend').value='';" class="jt">[删除]</span> <?php tips('请填写http://开头的绝对地址，目前支持FLV、MP4格式');?></td>
</tr>
<tr>
...
<input type="radio" name="setting[swfu]" value="2"  <?php if($swfu==2) echo 'checked';?>/> 后台开启 <?php tips('开启后，系统将采用SWFUpload上传文件，并带有进度提示');?>
</td>
</tr>
