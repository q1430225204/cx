...
class quote {
    ...
    function quote($moduleid) {
		...
		$this->db = &$db;
		$this->fields = array('catid','areaid','pid','level','title','style','fee','introduce','thumb','tag','status','hits','username','addtime','adddate', 'editor','edittime','ip','template', 'linkurl','filepath','note');
    }
	...
	function set($post) {
		global $MOD, $DT_TIME, $DT_IP, $QP, $_username, $_userid;
