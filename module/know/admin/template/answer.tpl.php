...
票数 (<?php echo $v['vote'];?>) &nbsp;|&nbsp;<a href="<?php echo $MODULE[3]['linkurl'];?>redirect.php?mid=<?php echo $moduleid;?>&itemid=<?php echo $v['qid'];?>" target="_blank">原文</a>
</span>
...
<?php if($v['linkurl']) { ?>
<div class="b5 c_b"> </div>
<div>参考资料：<a href="<?php echo $MODULE[3]['linkurl'];?>redirect.php?url=<?php echo urlencode($v['linkurl']);?>" target="_blank"><?php echo $v['linkurl'];?></a></div>
<?php } ?>
</td>
<td>
