...
class know {
    ...
    function know($moduleid) {
		...
		$this->db = &$db;
		$this->fields = array('catid','areaid','level','title','style','fee','credit','aid','process','hidden','introduce','addition','thumb','tag','status','hits','username','addtime','totime','editor','edittime','ip','template', 'linkurl','filepath','note');
    }
