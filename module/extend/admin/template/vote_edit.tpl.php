...
<td><?php echo type_select('vote', 1, 'post[typeid]', '请选择分类', $typeid, 'id="typeid"');?> <a href="?file=type&item=<?php echo $file;?>" class="t">[管理分类]</a> <span id="dtypeid" class="f_red"></span></td>
</tr>
<tr>
