...
<td class="px11"><?php echo $v['votes'];?></td>
<td class="px11"><?php echo $v['hits'];?></td>
<td class="px11"><?php echo $v['adddate'];?></td>
<td>
<a href="?moduleid=<?php echo $moduleid;?>&file=<?php echo $file;?>&action=edit&itemid=<?php echo $v['itemid'];?>"><img src="admin/image/edit.png" width="16" height="16" title="修改" alt=""/></a>&nbsp;
<a href="###" onclick="Dwindow('?moduleid=<?php echo $moduleid;?>&file=<?php echo $file;?>&action=record&itemid=<?php echo $v['itemid'];?>', '投票记录[<?php echo $v['title'];?>]');"><img src="admin/image/poll.png" width="16" height="16" title="投票记录" alt=""/></a>&nbsp;
