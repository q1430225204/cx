...
<td><input type="text" size="10" name="ad[key_id]" id="key_id"/> <a href="javascript:select_item('<?php echo $p['moduleid'];?>&itemid='+Dd('key_id').value);" class="t">选择..</a>  <span id="dkey_id" class="f_red"></span></td>
</tr>
<?php } ?>
<?php if($p['typeid'] == 7) { ?>
<tr>
