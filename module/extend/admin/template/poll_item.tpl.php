...
<a href="<?php echo $v['linkurl'];?>" target="_blank"><img src="<?php echo $MODULE[2]['linkurl'];?>image/img_select.gif" width="12" height="12" title="新窗口打开链接"/></a>
</td>
...
<td><a href="###" onclick="Dwindow('?moduleid=<?php echo $moduleid;?>&file=<?php echo $file;?>&action=record&pollid=<?php echo $v['pollid'];?>&itemid=<?php echo $v['itemid'];?>', '投票记录[<?php echo $P['title'];?>]');"><img src="admin/image/poll.png" width="16" height="16" title="投票记录" alt=""/></a></td>
</tr>
<?php } ?>
<tr>
