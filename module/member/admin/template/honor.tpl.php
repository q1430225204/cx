...
<td><a href="<?php echo $v['image'];?>" target="_blank"><img src="<?php echo $v['thumb'];?>" width="50" style="padding:5px;"/></a></td>
<td><a href="<?php echo userurl($v['username'], 'file=honor&itemid='.$v['itemid']);?>" target="_blank"><?php echo $v['title'];?></a></td>
