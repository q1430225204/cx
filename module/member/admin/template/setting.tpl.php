...
<td>
<input type="radio" name="setting[sso]" value="0" <?php if(!$sso) echo 'checked';?> onclick="Dh('sso');"/> 关闭&nbsp;&nbsp;
<input type="radio" name="setting[sso]" value="1" <?php if($sso) echo 'checked';?> onclick="Ds('sso');"/> 开启
</td>
</tr>
<tbody id="sso" style="display:<?php echo $sso ? '' : 'none';?>">
<tr>
<td class="tl">SSO API地址</td>
<td><input name="setting[sso_url]" type="text" size="50" value="<?php echo $sso_url;?>"/> <?php tips('SSO安装地址，以 / 结尾，例如 http://sso.destoon.com/');?></td>
</tr>
<tr>
<td class="tl">SSO 站点ID</td>
<td><input name="setting[sso_id]" type="text" size="5" value="<?php echo $sso_id;?>"/></td>
</tr>
<tr>
<td class="tl">SSO 通信密钥</td>
