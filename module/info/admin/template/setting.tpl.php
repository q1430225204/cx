...
<tr>
<td class="tl">首页显示按地区浏览</td>
<td>
<input type="radio" name="setting[show_iarea]" value="1"  <?php if($show_iarea) echo 'checked';?>/> 开启&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" name="setting[show_iarea]" value="0"  <?php if(!$show_iarea) echo 'checked';?>/> 关闭
</td>
</tr>
...
<tr>
<td class="tl">列表显示按地区浏览</td>
<td>
<input type="radio" name="setting[show_larea]" value="1"  <?php if($show_larea) echo 'checked';?>/> 开启&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" name="setting[show_larea]" value="0"  <?php if(!$show_larea) echo 'checked';?>/> 关闭
</td>
</tr>

<tr>
<td class="tl">列表搜索排行数量</td>
<td><input type="text" size="3" name="setting[page_lkw]" value="<?php echo $page_lkw;?>"/></td>
</tr>

<tr>
<td class="tl">内容显示留言咨询</td>
<td>
<input type="radio" name="setting[show_message]" value="1"  <?php if($show_message) echo 'checked';?>/> 开启&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" name="setting[show_message]" value="0"  <?php if(!$show_message) echo 'checked';?>/> 关闭
</td>
</tr>

<tr>
<td class="tl">内容相关信息数量</td>
