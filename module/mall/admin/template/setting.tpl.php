...
<tr>
<td class="tl">购物车容量</td>
<td><input type="text" size="3" name="setting[max_cart]" value="<?php echo $max_cart;?>"/> <?php tips('超出容量之后，系统自动删除最早加入购物车的商品，为了系统效率，建议控制在50内');?></td>
</tr>
