...
class exhibit {
    ...
    function exhibit($moduleid) {
		...
		$this->db = &$db;
		$this->fields = array('catid','areaid','level','title','style','fee','introduce','fromtime','totime','city','address','postcode','homepage','hallname','remark','thumb','sponsor','undertaker','truename','addr','telephone','mobile','fax','email','msn','qq','status','hits','username','addtime','editor','edittime','ip','template','linkurl','filepath','note');
    }
	...
	function pass($post) {
		...
		//if(!$post['city']) return $this->_(lang('message->pass_exhibit_city'));
