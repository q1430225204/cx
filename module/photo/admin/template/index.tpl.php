...
<?php } ?>
<td class="px11"><a href="?moduleid=<?php echo $moduleid;?>&action=item&itemid=<?php echo $v['itemid'];?>"><?php echo $v['items'];?></a></td>
<td class="px11"><?php echo $v['hits'];?></td>
<td>
<a href="?moduleid=<?php echo $moduleid;?>&action=item&itemid=<?php echo $v['itemid'];?>"><img src="admin/image/photo.gif" width="16" height="16" title="管理图片" alt=""/></a>&nbsp;
