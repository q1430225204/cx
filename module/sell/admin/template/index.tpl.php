...
供货：<input type="text" size="4" name="minamount" value="<?php echo $minamount;?>"/> ~ <input type="text" size="4" name="maxamount" value="<?php echo $maxamount;?>"/>&nbsp;
起订：<input type="text" size="4" name="minminamount" value="<?php echo $minminamount;?>"/> ~ <input type="text" size="4" name="maxminamount" value="<?php echo $maxminamount;?>"/>&nbsp;
<?php echo VIP;?>：<input type="text" size="2" name="minvip" value="<?php echo $minvip;?>"/> ~ <input type="text" size="4" name="maxvip" value="<?php echo $maxvip;?>"/>&nbsp;
...
<td align="left">&nbsp;<a href="<?php echo $v['linkurl'];?>" target="_blank"><?php echo $v['title'];?></a><?php if($v['vip']) {?> <img src="<?php echo DT_SKIN;?>image/vip.gif" title="<?php echo VIP;?>:<?php echo $v['vip'];?>"/><?php } ?>
</td>
<td><?php echo $v['price'] ? $v['price'] : '';?><?php echo $v['unit'] ? $DT['money_unit'].'/'.$v['unit'] : '';?></td>
<td>
<?php if($v['username']) { ?>
