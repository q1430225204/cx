...
FCKConfig.ToolbarSets["Destoon"] = [
	['PasteWord','PasteText','-','Bold','TextColor','FontSize','Link','Unlink','Image','Flash','Rule','SpecialChar','JustifyLeft','JustifyCenter','JustifyRight','Attach','FitWindow']
];
}
if(IsAdmin) {
FCKConfig.ToolbarSets["Simple"] = [
	['Source','-','Bold','Italic','Underline','TextColor','-','FontSize','Link','Unlink','-','Image','Smiley','JustifyLeft','JustifyCenter','JustifyRight','-','Attach','FitWindow']
];
} else {
FCKConfig.ToolbarSets["Simple"] = [
	['Bold','Italic','Underline','TextColor','-','FontSize','Link','Unlink','-','Image','Smiley','JustifyLeft','JustifyCenter','JustifyRight','-','Attach','FitWindow']
];
}
if(IsAdmin) {
FCKConfig.ToolbarSets["Basic"] = [
	['Source','-','Bold','TextColor','-','Link','Unlink','-','Image','JustifyLeft','JustifyCenter','JustifyRight']
];
} else {
FCKConfig.ToolbarSets["Basic"] = [
...
FCKConfig.FontNames		= '宋体;黑体;微软雅黑;楷体;Arial;Tahoma;Verdana;Comic Sans MS;Courier New;Times New Roman';
