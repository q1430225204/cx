...
<img src="<?php echo DT_PATH;?>api/oauth/baidu/ico.png" align="absmiddle"/> <a href="<?php echo $MODULE[3]['linkurl'];?>redirect.php?url=http://dev.baidu.com/connect/" target="_blank" class="t">帐号申请</a>
</td>
</tr>
